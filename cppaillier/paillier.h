...
public:
    static constexpr unsigned short const DEFAULT_KEYSIZE = 512;
...
class [[nodiscard]] PaillierEvaluationKey{
private:
    PaillierPublicKey pk{};
    int_t n,g,_n2;
public:
    int_t ck0, ck1;
    explicit PaillierEvaluationKey(const int_t &ck0, const int_t &ck1, const int_t &n);
    PaillierEvaluationKey() = default;
    [[nodiscard]] static int_t compare(const int_t &enc_n, const int_t &enc_m, const PaillierEvaluationKey &ek);
    [[nodiscard]] int_t compare(const int_t &enc_n, const int_t &enc_m) const;
    [[nodiscard]] json to_json() const;
    [[nodiscard]] std::string to_string() const;
};
...
public:
    ...
    [[nodiscard]] PaillierEvaluationKey generateEvaluationKey() const;
